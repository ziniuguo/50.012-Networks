...
class GoBackN:
  ...
  def _send_helper(self, msg):
    ...
    print("debugL: _send_helper: sender_base: " + str(self.sender_base)
          + " next_sequence_number: " + str(self.next_sequence_number))
  ...
  def handle_arrival_msg(self):
    ...
    if msg_data.msg_type == config.MSG_TYPE_ACK:
      ...
      print("debugL: handle_arrival_msg: sender_base after + 1: " + str(self.sender_base)
            + " next_sequence_number: " + str(self.next_sequence_number))
      if(self.sender_base == self.next_sequence_number):
